...
router.post(postBySkill, upload.single('pdf'), async (req, res) => {
    ...
    try {      
        ...
        //Verificar que no hayan campos vacios, esto se podria hacerf en el front
        if (!nombre || !description || !skillId) {
        ...
        await conexion.execute("INSERT INTO documents (fileName,documentName, description, uploadDate, skillId) VALUES(?,?,?,?,?)",
